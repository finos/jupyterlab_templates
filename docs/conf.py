...
# -*- coding: utf-8 -*-
#
# jupyterlab_templates documentation build configuration file, created by
...
_version_py = os.path.join('..', 'jupyterlab_templates', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'jupyterlab_templatesdoc'
...
latex_documents = [
    (master_doc, 'jupyterlab_templates.tex', 'jupyterlab_templates Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'jupyterlab_templates', 'jupyterlab_templates Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jupyterlab_templates', 'jupyterlab_templates Documentation',
     author, 'jupyterlab_templates', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    jupyterlab_templates_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'jupyterlab_templates'))
